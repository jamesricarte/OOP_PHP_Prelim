...
<body>
    ...
    <div class="edit-popup">
                <div class="profile-icon">
                    <h3 class="list-initial"><?php echo substr($nameedit, 0, 1) ?></h3>
                ...
                <div class="info-section">
                    <div class="container">
                        ...
                        <p class="value"><?php echo $nameedit; ?></p>
                    </div>

                    <div class="container">
                        <p class="label">Course:</p>
                        <p class="value"><?php echo $courseedit; ?></p>
                    </div>

                    <div class="container">
                        <p class="label">Block:</p>
                        <p class="value"><?php echo $blockedit; ?></p>
                    </div>
                </div>



                <button onclick="backtoDash()" class="update-button">Back to Dashboard</button>
                <script>
                    function backtoDash() {
